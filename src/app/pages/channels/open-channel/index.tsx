...
export default function OpenChannel() {
  ...
  const selectedContract = useMemo(() => {
    ...
    return rgbContractsQuery.data.contracts.find(
    ...
    <>
      <ContentWrapper>
        ...
        <Content>
          ...
          <Field className="mt-10">
            <FieldLabel>
              Transfer RGB Assets Into the Channel（Optional）
            </FieldLabel>
            <AssetSelect
              reset={() => {
        ...
        <DialogContent className="w-[560px]">
          ...
          <div>
            ...
            <div className="mt-3 text-sm text-secondary-foreground">
              Assets will be managed via RGB protocol.
            </div>
          </div>
          <div className="bg-background-3 rounded-2xl p-4">
